...
@php
    $conditionsRequests = json_encode([
        ['column' => 'name', 'operator' => '!=', 'value' => null],
        ['column' => 'approved', 'operator' => '=', 'value' => false],
        ['column' => 'rejected', 'operator' => '=', 'value' => false],
        ['column' => 'isBanned', 'operator' => '=', 'value' => false],
    ]);

    $conditionsList = json_encode([
        ['column' => 'approved', 'operator' => '=', 'value' => true],
        ['column' => 'isBanned', 'operator' => '=', 'value' => false],
    ]);

    $conditionsBannedUsers = json_encode([['column' => 'isBanned', 'operator' => '=', 'value' => true]]);

    $conditionsRejectedUsers = json_encode([['column' => 'rejected', 'operator' => '=', 'value' => true]]);

    $conditionsIncompleteUsers = json_encode([['column' => 'name', 'operator' => '!=', 'value' => null]]);
    ...
    <div class="users_wrapper" id="users_wrapper">
        ...
        <section class="row-2 table_wrapper">
            <div class="head">
                ...
                <div class="export-btn" style="margin-left: 24px">
                    @exportTable('users', true, $conditionsRequests)
                </div>
                <div class="pagination" v-if="users_requests_last_page > 1">
                    <button
                        @click="users_requests_current_page > 1 ? users_requests_current_page -= 1 : ''; this.getUsers('Requests', this.users_requests_current_page)">
                    ...
                    <button
                        @click="users_requests_current_page < users_requests_last_page ? users_requests_current_page += 1 : '';this.getUsers('Requests', this.users_requests_current_page)">
                ...
                <div class="form-group search">
                    <input type="text" name="search" id="search" placeholder="Search Requests Users" class="input"
                        v-model="Requests_search_words"
                        @input="this.users_requests_current_page = 1;this.getUsers('Requests', this.users_requests_current_page)">
            ...
            <table class="normal_table">
                ...
                <tbody>
                    <tr v-if="usersRequests && usersRequests.length > 0" v-for="user in usersRequests"
                        :key="user.id">
                        ...
                        <td>
                            <div class="btns flex-center">
                                <button class="button" @click="handleShowRequest(user)"><i
                                        class='bx bx-show-alt'></i></button>
                                {{-- <button class="button secondary" @click=""><i class='bx bx-envelope'></i></button> --}}
                                <button class="button success" @click="selectedRequest = user;handleShowApprovePopUp()"><i
                                        class='bx bx-check-circle'></i></button>
                                <button class="button danger"
                                    @click="selectedRequest = user;handleShowRejectionReasonPopUp()"><i
                                        class='bx bxs-user-x'></i></button>
                            </div>
                        </td>
                    </tr>
                    <tr v-if="!usersRequests || usersRequests.length == 0"
                        style="font-size: 20px; font-weight: 700; text-align: center">
                        <td colspan="5">
                            <h2>There is no requests!</h2>
                        </td>
                    </tr>
                </tbody>
            </table>
        ...
        <section class="row-2 table_wrapper">
            <div class="head">
                <h1>Users List</h1>
                <div class="export-btn" style="margin-left: 24px">
                    @exportTable('users', true, $conditionsList)
                </div>

                <div class="pagination" v-if="users_list_last_page > 1">
                    <button
                        @click="users_list_current_page > 1 ? users_list_current_page -= 1 : '';this.getUsers('Active', this.users_list_current_page)">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-caret-left-filled"
                            width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50"
                            fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path
                    ...
                    <button
                        @click="users_list_current_page < users_list_last_page ? users_list_current_page += 1 : '';this.getUsers('Active', this.users_list_current_page)">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-caret-right-filled"
                            width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50"
                            fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path
                ...
                <div class="form-group search">
                    <input type="text" name="search" id="search" placeholder="Search Active Users" class="input"
                        v-model="Active_search_words"
                        @input="this.users_list_current_page = 1;this.getUsers('Active', this.users_list_current_page)">
                    <i class='bx bx-search'></i>
                </div>
            </div>
            <table class="normal_table">
                ...
                <tbody>
                    <tr v-if="usersList && usersList.length > 0" v-for="user in usersList" :key="user.id">
                        ...
                        <td>
                            <div class="btns flex-center">
                                <button class="button" @click="selectedRequest = user;showUserProfile=true;"><i
                                        class='bx bx-show-alt'></i></button>
                                <button class="button danger" @click="selectedRequest = user;handleShowBanPopUp()"><i
                                        class='bx bxs-user-x'></i></button>
                            </div>
                        </td>
                    </tr>
        ...
        <section class="row-2 table_wrapper"
            v-if="incompleteUsers && incompleteUsers.length > 0 || Incomplete_search_words">
            <div class="head">
                <h1>Users Incomplete Registeration</h1>
                <div class="export-btn" style="margin-left: 24px">
                    @exportTable('users', true, $conditionsIncompleteUsers)
                </div>
                <div class="pagination" v-if="users_incomplete_last_page > 1">
                    <button
                        @click="users_incomplete_current_page > 1 ? users_incomplete_current_page -= 1 : '';this.getUsers('Incomplete', this.users_incomplete_current_page)">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-caret-left-filled"
                            width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50"
                            fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path
                    ...
                    <button
                        @click="users_incomplete_current_page < users_incomplete_last_page ? users_incomplete_current_page += 1 : '';this.getUsers('Incomplete', this.users_incomplete_current_page)">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-caret-right-filled"
                            width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50"
                            fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path
                ...
                <div class="form-group search">
                    <input type="text" name="search" id="search" placeholder="Search Incomplete Users"
                        class="input" v-model="Incomplete_search_words"
                        @input="users_incomplete_current_page= 1;this.getUsers('Incomplete', this.users_incomplete_current_page)">
                    <i class='bx bx-search'></i>
                </div>
            </div>
            <table class="normal_table">
                ...
                <tbody>
                    <tr v-if="incompleteUsers && incompleteUsers.length > 0" v-for="user in incompleteUsers"
                        :key="user.id">
                        <td>@{{ "ID_" + String(user.id).padStart(4, '0') }}</td>
                        <td>@{{ user.email }}</td>
                        <td>@{{ user.phone }}</td>
                    ...
                    <tr v-if="!incompleteUsers || incompleteUsers.length == 0"
                        style="font-size: 20px; font-weight: 700; text-align: center">
                        <td colspan="5">
                            <h2>There is no users!</h2>
                        </td>
        ...
        <section class="row-2 table_wrapper" v-if="bannedUsers && bannedUsers.length > 0">
            <div class="head">
                <h1>Banned Users</h1>
                <div class="export-btn" style="margin-left: 24px">
                    @exportTable('users', true, $conditionsBannedUsers)
                </div>

                <div class="pagination" v-if="users_banned_last_page > 1">
                    <button
                        @click="users_banned_current_page > 1 ? users_banned_current_page -= 1 : '';this.getUsers('Banned', this.users_banned_current_page)">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-caret-left-filled"
                            width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50"
                            fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path
                    ...
                    <button
                        @click="users_banned_current_page < users_banned_last_page ? users_banned_current_page += 1 : '';this.getUsers('Banned', this.users_banned_current_page)">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-caret-right-filled"
                            width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50"
                            fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path
                ...
                <div class="form-group search">
                    <input type="text" name="search" id="search" placeholder="Search Banned Users"
                        class="input" v-model="Banned_search_words"
                        @input="this.users_banned_current_page = 1;getUsers('Banned', this.users_banned_current_page)">
                    <i class='bx bx-search'></i>
                </div>
            </div>
            <table class="normal_table">
                ...
                <tbody>
                    ...
                    <tr v-if="!bannedUsers || bannedUsers.length == 0"
                        style="font-size: 20px; font-weight: 700; text-align: center">
                        <td colspan="5">
                            <h2>There is no banned users!</h2>
                        </td>
                    </tr>
                </tbody>
            </table>
        ...
        <section class="row-2 table_wrapper" v-if="rejectedUsers && rejectedUsers.length > 0 || Rejected_search_words">
            <div class="head">
                ...
                <div class="export-btn" style="margin-left: 24px">
                    @exportTable('users', true, $conditionsRejectedUsers)
                </div>

                <div class="pagination" v-if="users_rejected_last_page > 1">
                    <button
                        @click="users_rejected_current_page > 1 ? users_rejected_current_page -= 1 : '';this.getUsers('Rejected', this.users_rejected_current_page)">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-caret-left-filled"
                            width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50"
                            fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path
                    ...
                    <button
                        @click="users_rejected_current_page < users_rejected_last_page ? users_rejected_current_page += 1 : '';this.getUsers('Rejected', this.users_rejected_current_page)">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-caret-right-filled"
                            width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50"
                            fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path
                ...
                <div class="form-group search">
                    <input type="text" name="search" id="search" placeholder="Search Rejected Users"
                        class="input" v-model="Rejected_search_words"
                        @input="this.users_rejected_current_page = 1;getUsers('Rejected, this.users_rejected_current_page')">
                    <i class='bx bx-search'></i>
                </div>
            </div>
            <table class="normal_table">
                ...
                <tbody>
                    <tr v-if="rejectedUsers && rejectedUsers.length > 0" v-for="user in rejectedUsers"
                        :key="user.id">
                        <td>@{{ "ID_" + String(user.id).padStart(4, '0') }}</td>
                        <td>@{{ user.name }}</td>
                        <td>@{{ user.email }}</td>
                    ...
                    <tr v-if="!rejectedUsers || rejectedUsers.length == 0"
                        style="font-size: 20px; font-weight: 700; text-align: center">
                        <td colspan="5">
                            <h2>There is no rejected users!</h2>
                        </td>
                    </tr>
                </tbody>
            </table>
        ...
        <div class="hide-content" @click="showUserProfile = false"
            v-if="showBannedReasonPopup || showRequestDetails || rejectionReasonPopUp || showRjectionAlert || approvePopUp || showUserProfile">
        </div>
        ...
        <div class="pop-up card rejection_reason_pop_up" v-if="rejectionReasonPopUp">
            ...
            <div class="btns flex-center choices">
                <button :class="rejection_choice == 1 ? 'active' : ''"
                    @click="handleRejectionReason(1, 'Your Identity image is not avilable please Upload it')">Identity not
                    avilable</button>
                <button :class="rejection_choice == 2 ? 'active' : ''"
                    @click="handleRejectionReason(2, 'Your Identity image is not identical please Upload the correct one')">Identity
                    not identical</button>
                <button :class="rejection_choice == 3 ? 'active' : ''"
                    @click="handleRejectionReason(3, '')">Other</button>
            </div>
            <textarea name="reason" id="reason" cols="30" rows="10" class="input"
                placeholder="Type your reason" v-model="rejection_reason" v-if="rejection_choice == 3">
        </textarea>
            <div class="btns flex-center">
        ...
        <div class="pop-up card rejection_reason_pop_up" v-if="showBannedReasonPopup">
            ...
            <textarea name="reason" id="reason" cols="30" rows="10" class="input"
                placeholder="Type your reason" v-model="ban_reason">
        </textarea>
            <div class="btns flex-center">
            ...
            <div>
                ...
                <div>
                    <div style="max-height: 100px">
                        <h4>Total charged points</h4>
                        <p>
                            <i class='bx bx-money'></i> @{{ selectedRequest.total_charged_points }}
                        </p>
                        <h4>Used points</h4>
                        <p>
                            <i class='bx bx-money'></i> @{{ parseInt(selectedRequest.total_charged_points) - parseInt(selectedRequest.coins) }}
                        </p>
                    </div>
                    <div style="grid-column: span 2" v-if="selectedRequest.trips && selectedRequest.trips.length > 0">
                        <div style="width: 100%; max-height: 120px;grid-column: span 2;"
                            v-for="trip in selectedRequest.trips" :key="trip.id">
                            <img src="{{ asset('/dashboard/images/destination_icon.png') }}" alt="destination icon">
                            <div>
                                <p>@{{ trip.starting_location }} <span>@{{ trip.ended_at }}</span></p>
                                <p>@{{ trip.ending_location }} <span>- @{{ parseInt(trip.duration) * 15 }} coins</span></p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        createApp({
            ...
            methods: {
                async getUsers(type = null, page = 1) {
                    if (!this.Active_search_words && !this.Requests_search_words && !this
                        .Incomplete_search_words && !this.Banned_search_words && !this.Rejected_search_words)
                    ...
                    try {
                        ...
                        if (response.data.status === true) {
                            ...
                            if (response.data.data.incompleteUsers) {
                                ...
                                this.users_incomplete_current_page = response.data.data.incompleteUsers
                                    .current_page
